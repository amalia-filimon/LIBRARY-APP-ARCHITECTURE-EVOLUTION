...
public class FiltrareDupaDisponibilitateManager implements IComanda{
    private VMManager vmManager;
    public FiltrareDupaDisponibilitateManager(VMManager vm){
        vmManager = vm;
    }

    @Override
    public void executa() {
        String disponibilitateDeCautat = vmManager.getDisponibilitateTF();
