...
public class CautareCarteDupaTitluManager implements IComanda{
    private VMManager vmManager;
    public CautareCarteDupaTitluManager(VMManager vm){
        vmManager = vm;
    }

    @Override
    public void executa() {
        String titluDeCautat = vmManager.getTitluTF();
        ...
        {
            if(carte.getTitlu().equals(titluDeCautat)){
