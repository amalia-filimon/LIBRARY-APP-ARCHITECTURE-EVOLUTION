...
public class FiltrareDupaDomeniuManager implements IComanda{
    private VMManager vmManager;
    public FiltrareDupaDomeniuManager(VMManager vm){
        vmManager = vm;
    }

    @Override
    public void executa() {
        String domeniuDeCautat = vmManager.getDomeniuTF();
        ...
        {
            if(carte.getDomeniu().equals(domeniuDeCautat)){
