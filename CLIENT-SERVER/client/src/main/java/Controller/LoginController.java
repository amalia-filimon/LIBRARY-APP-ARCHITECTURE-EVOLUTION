...
public class LoginController {
    ...
    public void login(){
        ...
        Utilizator utilizatorDeCautatInBD = new UtilizatorBuilder().setUsername(username).setParola(parola).setRol(null).build();
        proxyServer.sendObject(utilizatorDeCautatInBD);
        Utilizator utilizatorObtinutDinBD = (Utilizator) proxyServer.receiveData();
        ...
        if(utilizatorObtinutDinBD == null){
            ...
            String locatieAngajatLogat = (String) proxyServer.receiveData();
            int id_librarie = (int) proxyServer.receiveData();
            List<Librarie> listaLibrarii = (List<Librarie>) proxyServer.receiveData();
            if(rol.equals("ADMINISTRATOR")){
                AdminController adminController = new AdminController(listaLibrarii);
                ...
                ManagerController managerController = new ManagerController(listaLibrarii);
            }
        }
    }
